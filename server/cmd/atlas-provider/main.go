...
var models = []any{&account.Account{}, &app.App{}, &auth.Auth{}, &emailverificationrequest.EmailVerificationRequest{}, &oauth.Oauth{}, &password.Password{}, &resetpasswordrequest.ResetPasswordRequest{}, &session.Session{}, &user.User{}}
